...
void Dialog::startThreads()
{
    ...
    if (nbIterations && nbThreads)
    {
        ...
        WonderfulCriticalSection criticalSection;
        criticalSection.initialize(nbThreads);
        ...
        {
            PcoThread *currentThread = new PcoThread(runTask, &criticalSection, nbIterations, i);
