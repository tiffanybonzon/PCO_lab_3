...
#include "../code/src/threadmanager.h"
...
QT_MOC_LITERAL(1, 14, 28), // "sig_incrementPercentComputed"
QT_MOC_LITERAL(2, 43, 0), // ""
QT_MOC_LITERAL(3, 44, 15) // "percentComputed"

    },
    "ThreadManager\0sig_incrementPercentComputed\0"
    "\0percentComputed"
};
...
void ThreadManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_incrementPercentComputed((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ThreadManager::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThreadManager::sig_incrementPercentComputed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ThreadManager::sig_incrementPercentComputed(double _t1)
{
